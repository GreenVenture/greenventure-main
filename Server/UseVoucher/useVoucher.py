...
def processUseVoucher(use):
    ...
    if code not in range(200, 300):
        ...
        my_object = {"email":use["email"] ,"message":returnMessage, "subject": "Voucher Usage"}
